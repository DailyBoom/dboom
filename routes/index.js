...
router.get('/home', function(req, res, next) {
  ...
  Product.find({ boxZone: req.session.zone, scheduled_at: { "$gte": moment().date(1).hour(0).minute(0).second(0) } }, {}, {sort : { 'scheduled_at' : 1 }}).populate('boxProducts').exec(function (err, products) {
