...
router.get('/zonecode', function(req, res) {
  Product.findOne({ _id: "56026fb1ad79928905a6998e" }, function(err, product) {
    ...
    res.render('extended', { product: product, progress: 10, no_time: true, title: "Zonecode", description: product.description, sale: sale.toFixed(0), image: product.images[0] });
  });
});
